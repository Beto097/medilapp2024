                                        ...
                                        @foreach($roles as $fila_rol)
                                            ...
                                            @if($rol!='')
                                                ...
                                                @if($fila_rol->id == $rol->id)
                                                    <option value="{{$fila_rol->id}}" selected>{{$fila_rol->nombre_rol}}@isset($fila_rol->compania) - {{$fila_rol->compania->compania_name}}@endisset </option>
                                                @else  
                                                    <option value="{{$fila_rol->id}}">{{$fila_rol->nombre_rol}}@isset($fila_rol->compania) - {{$fila_rol->compania->compania_name}}@endisset</option>
                                                @endif
                                            @else 
                                                <option value="{{$fila_rol->id}}">{{$fila_rol->nombre_rol}}@isset($fila_rol->compania) - {{$fila_rol->compania->compania_name}}@endisset</option>
                                            @endif
