...
class Controller extends BaseController
{
    ...
    public function index(){
        ...
        if (Auth::user()->rol->id == 1){
            ...
            return view('welcome',['companias'=>$companias]);
        }
    ...
    public function seleccionarCompania($id){
        ...
        Session::put('companiaName', $company->compania_name);
        Session::put('userName', $company->user_name); 
