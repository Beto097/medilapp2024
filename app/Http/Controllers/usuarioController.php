...
class usuarioController extends Controller
{
    public function index(){
        ...
        if(Auth::user()->accesoRuta('/usuario')){
            ...
            if (Auth::user()->rol->id == 1) {
                ...
                $resultado=User::where('compania_id',Auth::user()->compania_id)->get();
            }
    ...
    public function insert(Request $request){
        ...
        if(Auth::user()->accesoRuta('/usuario/create')){
            ...
            $obj_usuario->compania_id = $rol->compania_id;
            ...
            return redirect()->back()->withErrors(['danger' => 'Algo salio Mal....'])->withInput($request->all());
        }
